...
Full-stack MVP веб-приложения для создания и проведения интерактивных квизов. Организаторы создают квизы и запускают комнаты, а участники подключаются по коду, отвечают на вопросы и видят итоговую таблицу лидеров.
